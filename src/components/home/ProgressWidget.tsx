  ...
  return (
    <View className="mt-8">
      ...
      <View className="flex-row items-center justify-between mb-4">
        <Text className="text-base font-semibold text-ink" numberOfLines={1}>{t("your_progress")}</Text>
        <Pressable
      ...
      {/* Grid Row */}
      <View className="flex-row bg-surface border border-surface-light rounded-[28px] py-4">

        {/* 1. STREAK */}
        <View className="flex-1 items-center border-r border-surface-light px-2">
          <MaterialCommunityIcons name="fire" size={24} color="#FF9500" className="mb-2" />
          <Text className="text-xl font-semibold text-ink mb-1">{topStreak}</Text>
        ...
        <View className="flex-1 items-center border-r border-surface-light px-2">
          ...
          <Text className="text-xl font-semibold text-ink mb-1">{totalSessions}</Text>
        ...
        <View className="flex-1 items-center px-2">
          ...
          <Text className="text-xl font-semibold text-ink mb-1">{consistencyRate}%</Text>
